...
- [WebMCP Labs samples](https://github.com/MicrosoftEdge/webmcp-labs#samples) - Examples by Microsoft Edge demonstrating declarative forms, dynamic JavaScript tool registration, and a pizza-ordering workflow.
