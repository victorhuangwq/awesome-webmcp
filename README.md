...
- [WebMCP Labs](https://github.com/MicrosoftEdge/webmcp-labs#samples) - Samples by Microsoft Edge demonstrating declarative forms, dynamic JavaScript tool registration, and a pizza-ordering workflow.
